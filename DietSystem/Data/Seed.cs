                ...
                context.DishIngredients.AddRange(new List<DishIngredient>()
                    {
                     ...
                     /*new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Borsch").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "chicken fillet").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Borsch").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "lard").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Borsch").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "onion").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Borsch").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "sunflower oil").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Borsch").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "carrot").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Borsch").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "potato").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Borsch").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "white cabbage").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Borsch").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "tomato paste").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Borsch").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "beet").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Borsch").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "vinegar").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Borsch").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "sugar").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Borsch").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "salt").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Borsch").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "dill greens").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Borsch").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "green parsley").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Dumplings with cherry").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "cherry").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Dumplings with cherry").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "wheat flour").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Dumplings with cherry").Id,
                     ...
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Dumplings with cherry").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "water").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Dumplings with cherry").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "starch").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Dumplings with cherry").Id,
                     ...
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Dumplings with cherry").Id,
                            IngredientId = context.Dishes.Single(s=> s.Name == "chicken eggs").Id,
                     },
                     new DishIngredient()
                     {
                            DishId = context.Dishes.Single(s=> s.Name == "Dumplings with cherry").Id,
